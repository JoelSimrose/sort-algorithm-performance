...
/**
 *This class is used to test different sorting algorithms and compare their execution speed  
...
public class sortAlgorithmsTest {
	...
	public static long QuickSort(int[] randArray, int low, int high)
	{
		...
		while(left <= right)	// go through all of the array
		{
			
			// Find a number that is less than pivot number and a number that is greater than pivot and then switch them
	...
	*/
	public static long Sort(int[] randArray)
	{
		...
		int[] temp1 = new int[randArray.length/2];		// split array into two halves
